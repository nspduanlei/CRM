...
public class UpdateCustomUseCase extends UseCase<Result> {
    ...
    @Inject
    public UpdateCustomUseCase(GoodsRepository repository,
    ...
    public Observable<Result> buildObservable() {
        ...
        return mRepository.updateCustom(mRequestBody)
                .observeOn(mUiThread)
