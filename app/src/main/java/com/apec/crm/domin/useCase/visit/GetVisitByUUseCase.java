...
public class GetVisitByUUseCase extends UseCase<Result<ListPage<VisitRecord>>> {
    ...
    @Inject
    public GetVisitByUUseCase(GoodsRepository repository,
    ...
    public Observable<Result<ListPage<VisitRecord>>> buildObservable() {
        return mRepository.getVisitByU(mRequestBody)
                .observeOn(mUiThread)
