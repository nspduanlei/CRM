...
public class GetCustomDetailUseCase extends UseCase<Result<CustomDetail>> {
    ...
    @Inject
    public GetCustomDetailUseCase(GoodsRepository repository,
    ...
    @Override
    public Observable<Result<CustomDetail>> buildObservable() {

        return mRepository.getCustomDetail(mRequestBody)
                .observeOn(mUiThread)
